  ...
  return (
    <section className="antra-section antra-expertise items-start">
      <div className="antra-expertise-copy relative lg:sticky top-auto lg:top-32 mb-10 lg:mb-0">
        <p className="antra-kicker text-[#C2BAB0]">CAM KẾT CỦA KIM NGÂN</p>
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 relative z-10 px-2 sm:px-6">
              ...
              <div className="flex items-start gap-4 sm:gap-6">
                <span className="text-[#C2BAB0] text-sm sm:text-base font-serif italic mt-1 font-light tracking-widest">
                  {item.id}
                </span>
                <div>
                  <h3 className="text-xl sm:text-[22px] font-bold uppercase tracking-widest text-[#F2F0EC] group-hover:text-white transition-colors duration-300">
                    {item.label}
                  </h3>
              ...
              <div className="hidden sm:flex w-12 h-12 rounded-full border border-white/10 items-center justify-center group-hover:border-[#C2BAB0] group-hover:bg-[#C2BAB0] text-[#A39E96] group-hover:text-[#080808] transition-all duration-500 transform group-hover:rotate-45 flex-shrink-0 mt-1">
                <ArrowUpRight size={20} className="transition-transform duration-500" />
              </div>
            </div>

            {/* Premium hover gradient sweep */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#C2BAB0]/8 to-transparent -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-1000 pointer-events-none" />
          </div>
        ))}
      </div>
    </section>
