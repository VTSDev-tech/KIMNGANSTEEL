          ...
          {ORDER_PROCESS_STEPS.map((step, idx) => (
            ...
            >
              ...
              <img 
                src={step.img} 
                alt={step.title}
                className="absolute inset-0 w-full h-full object-contain p-3 bg-white transition-transform duration-700 group-hover:scale-105"
              />
              
              {/* Bottom Gradient for Text */}
              <div className="absolute inset-x-0 bottom-0 h-[40%] bg-gradient-to-t from-[#022119] via-[#064e3b]/80 to-transparent pointer-events-none" />
