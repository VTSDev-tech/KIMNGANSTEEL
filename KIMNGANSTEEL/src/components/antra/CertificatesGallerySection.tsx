...
export function CertificatesGallerySection() {
  ...
  return (
    <>
      <section ref={containerRef} className="py-20 md:py-28 px-6 md:px-14 bg-[#F7F7F4] border-b border-[#1A1918]/10">
        <div className="max-w-[1600px] mx-auto space-y-12">
          
          <div className="border-b border-[#1A1918]/10 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
            ...
            <p className="text-sm text-[#524D4A] max-w-sm leading-relaxed font-sans md:text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {CERTS.map((cert) => (
              ...
              >
                <div className="w-full aspect-[4/3] bg-white border border-[#1A1918]/10 overflow-hidden relative shadow-sm group-hover:shadow-md group-hover:border-[#C28E5C]/50 transition-all duration-500">
                ...
                <div className="space-y-1 px-1">
                  <h3 className="text-sm font-bold uppercase tracking-tight text-[#1A1918] group-hover:text-[#C28E5C] transition-colors">
                    {cert.title}
                  </h3>
        ...
        {selectedImage && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-12">
            <motion.div
              ...
              className="absolute inset-0 bg-[#0E0E0D]/95 backdrop-blur-lg cursor-zoom-out"
            />
