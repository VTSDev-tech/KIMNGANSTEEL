...
export function IntroScreen({ onComplete }: IntroScreenProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 z-[9999] overflow-hidden bg-[#043326] text-white"
    >
      {/* ── Background: dark radial ── */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_68%_72%_at_50%_46%,#064e3b_0%,#043326_75%,#043326_100%)]" />

      {/* ── Very subtle fine grid ── */}
      <div className="absolute inset-0 opacity-[0.25] [background-image:linear-gradient(to_right,rgba(255,255,255,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.06)_1px,transparent_1px)] [background-size:64px_64px] md:[background-size:80px_80px]" />
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        ...
        >
          {/* Outer ring */}
          <circle cx="350" cy="350" r="320" stroke="rgba(255,255,255,0.1)" strokeWidth="0.8" />
          {/* Main ring */}
          <circle cx="350" cy="350" r="232" stroke="rgba(255,255,255,0.15)" strokeWidth="0.9" />
          {/* Dashed inner ring */}
          <circle cx="350" cy="350" r="168" stroke="rgba(255,255,255,0.1)" strokeWidth="0.7" strokeDasharray="5 10" />
          {/* Innermost ring */}
          <circle cx="350" cy="350" r="80" stroke="rgba(255,255,255,0.05)" strokeWidth="0.6" />
          {/* Cross hairs inside ring */}
          <line x1="50" y1="350" x2="650" y2="350" stroke="rgba(255,255,255,0.08)" strokeWidth="0.7" />
          <line x1="350" y1="50" x2="350" y2="650" stroke="rgba(255,255,255,0.08)" strokeWidth="0.7" />
          {/* Accent gold dots */}
          ...
          <line x1="92" y1="92" x2="104" y2="92" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="98" y1="86" x2="98" y2="98" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="596" y1="92" x2="608" y2="92" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="602" y1="86" x2="602" y2="98" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="92" y1="608" x2="104" y2="608" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="98" y1="602" x2="98" y2="614" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="596" y1="608" x2="608" y2="608" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
          <line x1="602" y1="602" x2="602" y2="614" stroke="rgba(255,255,255,0.2)" strokeWidth="1.2" />
        </svg>
      </div>
      ...
      <div
        ref={hudRef}
        className="pointer-events-none absolute inset-0 z-20 font-mono text-[10px] tracking-[0.22em] text-white/70 opacity-0 p-7 md:p-10"
      >
        <div className="absolute top-8 left-7 flex items-center gap-2 md:left-10 md:top-10">
          <span className="h-1.5 w-1.5 rounded-full bg-[#ea580c]" />
          <span className="font-bold uppercase text-white">Kim Ngân Steel</span>
        </div>
        <div className="absolute top-8 right-7 hidden text-right text-white/70 sm:block md:right-10 md:top-10">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div
          ...
          style={{ marginTop: "-2vh" }}
        >
          {/* Big Shield Logo + Typography */}
          <div className="mb-4 flex flex-col items-center justify-center">
            <img
              src="/logomoi.svg"
              alt="Kim Ngân Steel Shield"
              className="w-[140px] md:w-[180px] lg:w-[200px] h-auto object-contain drop-shadow-[0_28px_56px_rgba(0,0,0,0.4)] mb-8"
            />
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-sans font-extrabold uppercase tracking-tight text-white leading-[1.05] drop-shadow-2xl">
              KIM NGÂN<br/>STEEL
            </h1>
          </div>
      ...
      <div className="pointer-events-none absolute bottom-10 md:bottom-14 left-1/2 z-30 flex -translate-x-1/2 flex-col items-center">
        <div ref={loadingContainerRef} className="flex flex-col items-center font-mono">
          <div className="relative h-[1.5px] w-[180px] overflow-hidden rounded-full bg-white/10">
            <div
              className="absolute left-0 top-0 bottom-0 bg-white transition-all duration-150 ease-out"
              style={{ width: `${progress}%` }}
            />
          </div>
          <div className="mt-3 text-[9px] tracking-[0.24em] text-white/70 font-mono">
