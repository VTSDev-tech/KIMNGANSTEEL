...
export function FinancialCapabilitySection() {
  ...
  return (
    <section ref={containerRef} className="py-20 md:py-28 px-6 md:px-14 bg-[#F7F7F4] text-[#1A1918] border-b border-[#1A1918]/10 select-none">
      <div className="max-w-[1560px] mx-auto space-y-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 pb-4">
          <div className="space-y-4 max-w-3xl fin-animate-up">
            ...
            <p className="text-xs sm:text-sm text-[#524D4A] font-sans leading-relaxed max-w-xl">
          ...
          <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-white border border-[#1A1918]/10 shadow-sm text-xs font-mono text-[#524D4A] tracking-wider uppercase self-start lg:self-auto fin-animate-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#1A1918]/10 border-t border-[#1A1918]/10 pt-10 fin-animate-up">
          
          {/* Highlight 1: Doanh Thu */}
          <div className="py-6 md:py-0 md:pr-10 space-y-3">
            <div className="flex items-baseline gap-1.5">
              <span className="text-5xl sm:text-6xl font-mono font-bold text-[#C28E5C] tracking-tight">
                720,2
              </span>
              <span className="text-xl font-mono font-bold text-[#C28E5C] uppercase">
                TỶ
              </span>
            </div>
            <div className="space-y-0.5">
              <p className="text-xs sm:text-sm font-sans text-[#1A1918] font-medium leading-snug">
                Doanh thu bán hàng và cung cấp dịch vụ
              </p>
              <p className="text-xs font-sans text-[#1A1918] font-bold">
                năm 2024
              </p>
            </div>
          </div>
